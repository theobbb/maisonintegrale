        ...
        <Typography variant='h4' sx={{position: 'relative', height: '100%', marginLeft: '-2px', marginTop: '2px'}} >
            ...
            sx={{display: 'flex', py:0.5, borderRadius: 1, marginRight: 1, fontSize: 'inherit', height: '100%', transformOrigin: '0% 100%' }}>
                ...
                viewBox="0 0 138 100">
                    ...
                    ...drawerOpen && {transform: 'rotate(45deg) translate(10%, -15%)'}
                    }} 
                    x='1' width="138" height="12" rx="9"/>
                    <rect style={{transition, transformOrigin: 'right top', 
                    ...drawerOpen && {transform: 'rotate(-45deg) translate(-8%, -65%) scaleX(1.1)'}
                    }} 
                    x='1' y="41" width="125" height="12" rx="9"/>
                    <rect style={{transition, ...drawerOpen && {transform: 'translate(-100%)', opacity: 0}}} 
                    x='1' y="81" width="92" height="12" rx="9"/>
